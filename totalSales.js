...
export function totalSalesFunc(allProducts){
    ...
    allSales = {
        'PRODUCTO': 'CANTIDAD',
        'PUPUSAS ORIGINAL/PORK': (allProducts['modifiers']['PUPUSAS Original / Pork'] || 0) + (allProducts['modifiers']['Pup. Original'] || 0)
                                + (allProducts['selection']['PUPUSA ORIGINAL'] || 0),

        'PUPUSAS CHICHARRON': (allProducts['modifiers']['PUPUSAS Chicharron'] || 0) + (allProducts['modifiers']['Pup. Chicharron'] || 0)
                            + (allProducts['selection']['PUPUSA CHICHARRON'] || 0),

        'PUPUSAS RAJAS': (allProducts['modifiers']['PUPUSAS Rajas Poblanas'] || 0) + (allProducts['modifiers']['Pup. Rajas'] || 0)
                        + (allProducts['selection']['PUPUSA RAJAS POBLANAS'] || 0),

        'PUPUSAS RES/BEEF': (allProducts['modifiers']['PUPUSAS Res / Beef'] || 0) + (allProducts['modifiers']['Pup. Res'] || 0)
                            + (allProducts['selection']['PUPUSA BEEF'] || 0),

        'PUPUSAS BEANS & CHEESE': (allProducts['modifiers']['PUPUSAS Beans & Cheese'] || 0) + (allProducts['modifiers']['Pup. Frijol / Queso'] || 0)
                            + (allProducts['selection']['PUPUSA BEANS & CHEESE'] || 0),

        'PUPUSAS CHEESE': (allProducts['modifiers']['PUPUSAS Cheese'] || 0) + (allProducts['modifiers']['Pup. Queso'] || 0)
                        + (allProducts['selection']['PUPUSA CHEESE/QUESO'] || 0),

        'GORDITAS ORIGINAL/PORK': (allProducts['modifiers']['GORDITAS Original (Pork)'] || 0) + (allProducts['modifiers']['Gor. Original (pork)'] || 0)
                                + (allProducts['selection']['GORDITA ORIGINAL (PORK)'] || 0),

        'GORDITAS CHICHARRON ROJO': (allProducts['modifiers']['GORDITAS Chicharron ROJO'] || 0) + (allProducts['modifiers']['Gor. Chicharron ROJO'] || 0)
                                + (allProducts['selection']['GORDITA CHICHARRON SALSA ROJA'] || 0),

        'GORDITAS CHICHARRON VERDE': (allProducts['modifiers']['GORDITAS Chicharron VERDE'] || 0) + (allProducts['modifiers']['Gor. Chicharron VERDE'] || 0)
        ...
        'GORDITAS CHEESE': (allProducts['modifiers']['Gor. Queso'] || 0) + (allProducts['modifiers']['GORDITAS Cheese / Queso'] || 0)
                            + (allProducts['selection']['GORDITA CHEESE'] || 0),

        'LLORARAS ORIGINAL/PORK': (allProducts['modifiers']['TACO LLORARAS Lloraras ORIGINAL'] || 0) + (allProducts['modifiers']['TACO LLORARAS'] || 0)
                                + (allProducts['modifiers']['Llor. Original'] || 0) + (allProducts['selection']['TACO LLORARAS'] || 0),

        'LLORARAS VEGGIE': (allProducts['modifiers']['TACO LLORARAS Lloraras VEGGIE'] || 0) + (allProducts['modifiers']['Llor. Veggie'] || 0)
                         + (allProducts['selection']['TACO LLORARAS VEGGIE'] || 0),

        'TACOS PLANCHA': (allProducts['modifiers']['TACO PLANCHA'] || 0) + (allProducts['modifiers']['Taco Plancha'] || 0)
                        + (allProducts['selection']['TACO PLANCHA'] || 0) + (allProducts['selection']['PLATE 2 - 4 TACOS PLANCHA'] || 0)
                        + (allProducts['selection']['1/2 DOZEN TACOS PLANCHA'] || 0) + (allProducts['selection']['DOZEN TACOS PLANCHA'] || 0)
                        + (allProducts['selection']['KIDS - TACOS PLANCHA (2)'] || 0),

        'TACO DE CHICHARRON': (allProducts['selection']['TACO CHICHARRON EN SALSA VERDE'] || 0) + (allProducts['selection']['TACO CHICHARRON EN SALSA ROJA'] || 0)
        ...
        'OVNIS': (allProducts['modifiers']['OVNIS'] || 0) + (allProducts['selection']['PLATE 7 - 2 OVNIS'] || 0)
        ...
        'CHICHARRON': (allProducts['modifiers']['CHICHARRON'] || 0) + (allProducts['selection']['CAZUELA DE CHICHARRON EN SALSA VERDE'] || 0)
                    + (allProducts['selection']['CAZUELA DE CHICHARRON EN SALSA ROJA'] || 0),

        'QUESADILLAS': (allProducts['selection']['PL QUESADILLAS FRITAS'] || 0) + (allProducts['selection']['KIDS - QUESADILLAS (2)'] || 0)
                    + (allProducts['selection']['QUESADILLA HARINA'] || 0) + (allProducts['selection']['QUESADILLA MAIZ'] || 0), 

        'PANELA': (allProducts['modifiers']['PANELA'] || 0) + (allProducts['selection']['GRILLED PANELA CAZUELA'] || 0),

        'QUESO FRESCO': (allProducts['selection']['QUESO FRESCO'] || 0),

        'PLATE HUEVOS': (allProducts['selection']['PL HUEVOS RANCHEROS'] || 0) + (allProducts['selection']['PL HUEVOS AL GUSTO'] || 0)
                    + (allProducts['selection']['PL HUEVOS A LA MEXICANA'] || 0) + (allProducts['selection']['PL HUEVOS DIVORCIADOS'] || 0),
        ...
        'FRIJOLES CON VENENO': (allProducts['selection']['CAZUELA DE FRIJOLES CON VENENO'] || 0),
        
        'ARROZ/RICE': (allProducts['selection']['ARROZ / RICE'] || 0),
        
        'PAN DE ELOTE': (allProducts['selection']['PAN DE ELOTE'] || 0),
        
        'GORDITAS DE AZUCAR': (allProducts['selection']['GORDITAS DE AZUCAR W/ICE CREAM'] || 0),
        
        'PLATE PANCAKES (3)': (allProducts['selection']['PL PANCAKES (3)'] || 0),

        'GALLETAS/EMPANADAS': (allProducts['selection']['DON DELI GALLETAS/EMPANADAS'] || 0),
