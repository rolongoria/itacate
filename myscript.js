...
import {
  parentMenuSelection,
  modifierColumnNames,
} from "./itemModifierProducts.js";
import {
  productsObjectNames,
  itemModifierMultiplier,
  itemSelectionMultiplier,
} from "./namesAndMultipliers.js";
...
function printItemSelectionFunc(itemObject) {
  let selection = printItemSelection(
    itemObject,
    itemSelectionProducts,
    productsObjectNames,
    itemSelectionMultiplier,
  );
...
function printItemModifiersFunc(itemObject) {
  let modifiers = printItemModifiers(
    itemObject,
    productsObjectNames,
    modifierColumnNames,
    parentMenuSelection,
